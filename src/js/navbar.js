...
import { Home, Plus, Award, Settings, Archive } from "react-feather";
    ...
    <Container fluid className="px-0">
      <Segment color="teal" className="p-0 mobile-nav-segment">
        <ul className="mobile-ul p-0 mx-0">
          ...
          <li>
            <a href="./" className="mobile-link">
              <Award size={25} color="teal" />
              <h5 className="p-0 m-0">Achievements</h5>
            </a>
          </li>
          <li>
            <a href="./" className="mobile-link">
              <Settings size={25} color="teal" />
  ...
  return (
    <Container className="px-0" fluid>
      <Segment raised className="px-5 desktop-nav-segment py-0">
        <h2 className="m-0">what-todo.app</h2>
        <ul className="desktop-ul">
          ...
          <li id="create-button-desktop">
            <a href="./" className="desktop-link py-2">
              <Plus size={25} color="teal" />
              <h5 className="p-0 m-0" style={{ color: "teal" }}>
                Create
              </h5>
            </a>
          </li>
